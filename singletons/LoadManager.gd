...
signal progress_changed(progess)
signal load_done

var _load_screen_path: String = "res://scenes/LoadScreen.tscn"
...
func load_scene(scene_path: String) -> void:
	...
	await Signal(new_loading_screen, "_loading_screen_has_full_coverage")
	start_load()
...
func _process(_delta: float) -> void:
	...
	match load_status:
		0,2:
			# THREAD_LOAD_INVALID_RESOURCE, THREAD_LOAD_FAILED
			set_process(false)
			return
		1:
